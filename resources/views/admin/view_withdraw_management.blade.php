    ...
    <div class="mx-auto px-3 maxContainer">
        ...
        <main class="mt-4 ms-auto">
            ...
            <div class="pageHeading">
                <h2 class="m-0">Edit Withdraw Management</h2>
        ...
        <div class="alert alert-success alert-dismissible fade show" role="alert"> 
            ...
            @endif
                ...
                <form action="{{url('upload_withdraw_management',$data->id)}}" method="post" enctype="multipart/form-data"> 
                @csrf
...
<div class="mb-3">
  ...
  <input type="text"  name="amount"    class="form-control" id="exampleFormControlInput1"  value="{{$data->amount}}">
</div>

<div class="mb-3">
  <label for="exampleFormControlInput1" class="form-label">Stake</label>
  <input type="text"  name="stake"    class="form-control" id="exampleFormControlInput1"  value="{{$data->stake}}">
</div>

<div class="mb-3">
  <label for="exampleFormControlInput1" class="form-label">Profit</label>
  <input type="text"  name="profit"    class="form-control" id="exampleFormControlInput1"  value="{{$data->profit}}">
</div>


<div class="mb-3">
  <label for="exampleFormControlInput1" class="form-label">Annuity Profit</label>
  <input type="text"  name="annuity_profit"    class="form-control" id="exampleFormControlInput1"  value="{{$data->annuity_profit}}">
</div>


<div class="mb-3">
  <label for="exampleFormControlInput1" class="form-label">Return</label>
  <input type="text"  name="_return"    class="form-control" id="exampleFormControlInput1"  value="{{$data->_return}}">
</div>
