...
class DepositDynamicPDFController extends Controller
{
    function index()
    {
    ...
    {
     $customer_data = DB::table('deposit_funds_full')
         ->limit(10)
         ->get();
    ...
    function convert_customer_data_to_html()
    {
     $customer_data = $this->get_customer_data();
     $output = '
     <h3 align="center">Deposits Management Data</h3>
     <table width="100%" style="border-collapse: collapse; border: 0px;">
      <tr>
    <th style="border: 1px solid; padding:12px;" width="20%">DATE</th>
    <th style="border: 1px solid; padding:12px;" width="30%">DEPOSITOR</th>
    ...
    <th style="border: 1px solid; padding:12px;" width="20%">ATTACHED FILE</th>
    <th style="border: 1px solid; padding:12px;" width="20%">AMOUNT</th>
     ...
     foreach($customer_data as $customer)
     {
      ...
      <tr>
       ...
       <td style="border: 1px solid; padding:12px;">'.$customer->image.'</td>
       <td style="border: 1px solid; padding:12px;">'.$customer->deposit_amount.'</td>
      </tr>
      ';
     }
     $output .= '</table>';
